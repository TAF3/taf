...
class TestTGs(object):
    ...
    def test_lldp_build_capture(self, tg):
        ...
        lldp_pack[1]["LLDP"]["tlvlist"].insert(-1, lldp_managment_with_oid)
        lldp_pack[1]["LLDP"]["tlvlist"].insert(-1, lldp_org_spec_tlv_1)
        lldp_pack[1]["LLDP"]["tlvlist"].insert(-1, lldp_org_spec_tlv_2)
